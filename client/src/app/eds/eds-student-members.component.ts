...
@Component({
  selector: 'app-eds-student-members',
  templateUrl: './eds-student-members.component.html',
  styleUrls: ['./eds-student-members.component.css'],
})
export class EdsStudentMembersComponent implements OnInit {
  members: Member[];
  appUserId: number;
