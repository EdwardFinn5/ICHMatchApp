...
@Component({
  selector: 'app-eds-positiona-ac-bullets',
  templateUrl: './eds-positiona-ac-bullets.component.html',
  styleUrls: ['./eds-positiona-ac-bullets.component.css'],
})
export class EdsPositionaAcBulletsComponent implements OnInit {
  member: Member;
  firstName?: string = '';
  appUserId: number;
