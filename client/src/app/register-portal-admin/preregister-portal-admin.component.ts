...
@Component({
  selector: 'app-preregister-portal-admin',
  templateUrl: './preregister-portal-admin.component.html',
  styleUrls: ['./preregister-portal-admin.component.css'],
})
export class PreregisterPortalAdminComponent implements OnInit {
  preregisterPortalAdminForm: UntypedFormGroup;
  ...
  initializeForm() {
    this.preregisterPortalAdminForm = this.fb.group({
  ...
  preregisterPortalAdmin() {
    this.toastr.success('Register code is valid');
    this.router.navigateByUrl('/registerportaladmin');
  }
